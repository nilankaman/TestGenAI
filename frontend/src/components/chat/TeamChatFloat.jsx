...
const SEED_MSGS = [
  ...
  { id: 2, from: 2, text: 'On it, finishing the API tests now 🎉', time: '9:03 AM', file: null },
]
...
const ALLOWED = ['.pdf','.png','.jpg','.jpeg','.gif','.webp','.xlsx','.xls','.csv']
        ...
        <div className={s.panel}>
                  ...
                  <div className={`${s.bubble} ${isMe ? s.bubbleMe : s.bubbleThem}`}>
                    ...
                    {m.file && (
                      <div className={s.fileAttach}>
                        {m.file.preview ? (
                          <img src={m.file.preview} alt={m.file.name} className={s.fileThumb} />
                        ) : (
          ...
          {staged && (
            <div className={s.stagedFile}>
              <div className={s.stagedFileLeft}>
                {staged.preview ? (
                  <img src={staged.preview} alt={staged.name} className={s.stagedThumb} />
                ) : (
              ...
              <button className={s.stagedRemove} onClick={clearStaged} title="Remove">✕</button>
            </div>
          )}

          {fileError && (
            <div className={s.fileError}>{fileError}</div>
          )}
          ...
          <div className={s.inputWrap}>
            ...
            <input
              ...
              onKeyDown={onKey}
              placeholder={staged ? 'Add a message (optional)…' : 'Message team…'}
            />
            <button
