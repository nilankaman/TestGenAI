        ...
        <div className={s.overviewGrid}>
          ...
          <div className={s.card}>
            ...
            <div className={s.activityList}>
              {[
                ...
                {
                  user: "Marco R.",
                  action: "Shared with 3 teammates",
                  time: "2h ago",
                  icon: "📤",
                },
                {
                  user: "Demo",
                  action: "Logged in via demo mode",
                  time: "3h ago",
                  icon: "👤",
                },
              ].map((a, i) => (
          ...
          <div className={s.card}>
            ...
            <div className={s.payStats}>
              ...
              <div className={s.payStat}>
                <p className={s.payVal} style={{ color: "#4ade80" }}>
                  3
                </p>
                <p className={s.payLbl}>Successful</p>
              </div>
              <div className={s.payStat}>
                <p className={s.payVal} style={{ color: "#f87171" }}>
                  1
                </p>
            ...
            <div className={s.healthList}>
              {[
                ...
                <div key={h.name} className={s.healthRow}>
                  ...
                  <span className={s.healthStatus} style={{ color: "#4ade80" }}>
                    online
                  </span>
                </div>
              ))}
                    ...
                    <td>
                      <span
                        ...
                        style={{
                          ...
                          borderColor: `${PLAN_COLOR[u.plan]}44`,
                        }}
                      >
                        {u.plan}
                      </span>
            ...
            <table className={s.table}>
              ...
              <tbody>
                {MOCK_PAYMENTS.map((p) => (
                  <tr key={p.id}>
                    <td>
                      <span className={s.payId}>{p.id}</span>
                    </td>
                    <td
                    ...
                    <td>
                      <span
                        className={s.planTag}
                        style={{
                          color: PLAN_COLOR[p.plan.toLowerCase()],
                          background: `${PLAN_COLOR[p.plan.toLowerCase()]}18`,
                          borderColor: `${PLAN_COLOR[p.plan.toLowerCase()]}44`,
                        }}
                      >
                        {p.plan}
                      </span>
