...
const QUICK_PROMPTS = [
  {
    label: "🧪 Review my test cases",
    text: "Can you review my test cases and suggest improvements?",
  },
  {
    label: "📋 Write a test plan",
    text: "Help me write a test plan for a login feature",
  },
  {
    label: "🔌 API test example",
    text: "Show me a RestAssured example for testing a GET endpoint",
  },
  {
    label: "⚡ Cypress vs Selenium",
    text: "What are the key differences between Cypress and Selenium?",
  },
  {
    label: "🥒 BDD best practices",
    text: "What are BDD best practices with Cucumber?",
  },
  {
    label: "📱 Mobile test tips",
    text: "Tips for writing good Appium tests for a login flow",
  },
];
...
function Message({ msg }) {
  ...
  return (
    ...
    >
      {!isUser && <div className={styles.aiAvatar}>🤖</div>}
      <div
      ...
      >
        ...
        {msg.content.split("```").map((part, i) =>
          i % 2 === 1 ? (
            ...
            <span key={i} className={styles.bubbleText}>
              {part}
            </span>
          ),
        )}
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hey! I'm your TestGen AI assistant. I'm here to help with test cases, automation frameworks, QA strategies, and anything else testing-related.\n\nWhat are you working on today?",
      time: "Now",
      id: 0,
    },
  ]);
          ...
          <div className={styles.titleRow}>
            ...
            <div>
              ...
              <p className={styles.subtitle}>
                Powered by Claude — your senior QA engineer on demand
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.messages}>
          ...
          {loading && (
            <div className={`${styles.message} ${styles.messageAi}`}>
              ...
              <div
                className={`${styles.bubble} ${styles.bubbleAi} ${styles.typingBubble}`}
              >
