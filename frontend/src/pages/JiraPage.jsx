...
const MOCK_ISSUES = [
  {
    id: "TC-101",
    title: "Login page — null pointer on empty email",
    type: "Bug",
    priority: "High",
    status: "Open",
  },
  {
    id: "TC-98",
    title: "Add cart API returns 500 on duplicate item",
    type: "Bug",
    priority: "High",
    status: "In Progress",
  },
  {
    id: "TC-95",
    title: "Payment flow missing edge case coverage",
    type: "Task",
    priority: "Medium",
    status: "Open",
  },
  {
    id: "TC-91",
    title: "Mobile login — biometric fallback not tested",
    type: "Task",
    priority: "Medium",
    status: "Open",
  },
  {
    id: "TC-88",
    title: "Search results pagination — boundary tests",
    type: "Task",
    priority: "Low",
    status: "Open",
  },
          ...
          <div className={styles.titleRow}>
            ...
            <div>
              ...
              <p className={styles.subtitle}>
                Sync your test cases directly to Jira issues
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.connectCard}>
            <div className={styles.connectCardHeader}>
              ...
              <div>
                ...
                <p className={styles.connectSub}>
                  Enter your Atlassian credentials to get started
                </p>
              </div>
            </div>
            ...
            <div className={styles.helpRow}>
              <div className={styles.helpItem}>
                <span>🔒</span>
                <span>
                  Your credentials are never stored — only used per session
                </span>
              </div>
              <div className={styles.helpItem}>
                <span>📖</span>
                ...
                <>
                  <div className={styles.projectHeader}>
                    <div className={styles.projectHeaderLeft}>
                      <span className={styles.projectHeaderIcon}>
                        {selectedProject.icon}
                      </span>
                      <div>
                        <h2 className={styles.projectHeaderName}>
                          {selectedProject.name}
                        </h2>
                        <p className={styles.projectHeaderMeta}>
                          {selectedProject.id} · {selectedProject.type}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className={styles.pushPanel}>
                      <div className={styles.pushHeader}>
                        ...
                        <p className={styles.pushSub}>
                          Create Jira issues directly from your generated test
                          cases
                        </p>
                      </div>
                    ...
                    <div className={styles.syncPanel}>
                      <div className={styles.syncSummary}>
                        <div className={styles.syncStat}>
                          <span className={styles.syncStatVal}>
                            {MOCK_ISSUES.length}
                          </span>
                        ...
                        <div className={styles.syncStat}>
                          <span
                            ...
                            style={{ color: "#fb923c" }}
                          >
                            {MOCK_ISSUES.length - syncedIds.length}
                          </span>
                      ...
                      <p className={styles.syncNote}>
                        TestGen AI will analyse each open issue and generate
                        relevant test cases automatically. Results will appear
                        in your History page.
                      </p>
                    </div>
                  )}
                </>
