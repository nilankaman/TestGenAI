...
function StatCard({ icon, value, label, delta, color }) {
  return (
    <div className={styles.statCard} style={{ "--card-accent": color }}>
      ...
      {delta && (
        <div
          className={`${styles.statCardDelta} ${delta.startsWith("+") ? styles.deltaUp : styles.deltaDown}`}
        >
          {delta}
        </div>
      )}
      ...
      <header className={styles.header}>
          ...
          <div className={styles.headerTitleRow}>
            ...
            <div>
              ...
              <p className={styles.headerSub}>
                Your testing activity at a glance
              </p>
            </div>
          </div>
        </div>
        <div className={styles.headerRight}>
          ...
          <button
            ...
            onClick={() =>
              setLoaded(false) || setTimeout(() => setLoaded(true), 100)
            }
          >
            🔄 Refresh
          </button>
        ...
        <div className={styles.chartsRow}>
          ...
          <div className={styles.chartCard}>
            <div className={styles.chartCardHeader}>
              ...
              <button
                className={styles.chartCardLink}
                  ...
                  <div className={styles.projectBarWrap}>
                    <div className={styles.projectBar}>
                      <div
                        ...
                        style={{ width: `${p.coverage}%`, background: p.color }}
                      />
                    </div>
                    <span
                      className={styles.projectCoverage}
                      style={{ color: p.color }}
                    >
                      {p.coverage}%
                    </span>
            ...
            <div className={styles.activityList}>
              {recentActivity.map((item) => (
                <div key={item.id} className={styles.activityItem}>
                  <div
                    className={`${styles.activityDot} ${styles[`dot_${item.status}`]}`}
                  />
                  <div className={styles.activityBody}>
                    ...
                    <p className={styles.activityMeta}>
                      ...
                      ·{" "}
                      <span className={styles.activityFramework}>
                        {item.framework}
                      </span>
                      · {item.time}
                    </p>
