            ...
            <tbody>
              {history.map(row => (
                <tr key={row.id} className={styles.row}>
                  ...
                  <td className={styles.countCell}>{row.testCases?.length ?? '—'}</td>
                  <td>
                    <span className={`${styles.status} ${styles[`status_${STATUS_COLORS[row.status]}`]}`}>
                      {row.status}
                    </span>
                  </td>
                  <td className={styles.mutedCell}>{formatDate(row.createdAt)}</td>
                  <td>
                    <button
