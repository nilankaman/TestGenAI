...
const QA_FACTS = [
  ...
  { icon: "⚡", label: "CI/CD pipelines run", value: "tests on every push" },
  {
    ...
    value: "prevents old bugs returning",
  },
];
      ...
      <div className={styles.hero}>
        <div className={styles.heroLeft}>
          ...
          <p className={styles.heroSub}>
            Manage your identity, track your testing stats, and level up your QA
            game.
          </p>
          <div className={styles.qaBadges}>
            {QA_BADGES.map((b) => (
              <span key={b} className={styles.qaBadge}>
                {b}
              </span>
            ))}
          </div>
        ...
        <div className={styles.rightCol}>
          ...
          <div className={styles.qaVisual}>
            ...
            <div className={styles.pyramid}>
              <div className={styles.pyramidRow} data-level="e2e">
                <span>E2E Tests</span>
              </div>
              <div className={styles.pyramidRow} data-level="integration">
                <span>Integration Tests</span>
              </div>
              <div className={styles.pyramidRow} data-level="unit">
                <span>Unit Tests</span>
              </div>
            </div>
            <p className={styles.pyramidLegend}>
              Fast & cheap at the base → Slow & expensive at the top
            </p>
          </div>
