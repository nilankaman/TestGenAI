...
const FLOATING_TESTS = [
  { type: 'PASS', text: 'validLogin_returnsJwt()',         delay: '0s',   top: '12%', left: '5%'   },
  { type: 'PASS', text: 'register_newUser_returns200()',   delay: '1.2s', top: '26%', left: '8%'   },
  { type: 'FAIL', text: 'nullPassword_throwsException()',  delay: '0.6s', top: '42%', left: '4%'   },
  { type: 'PASS', text: 'jwtToken_isValid()',              delay: '1.8s', top: '57%', left: '7%'   },
  { type: 'SKIP', text: 'oauthLogin_pending()',            delay: '0.3s', top: '72%', left: '10%'  },
  { type: 'PASS', text: 'bcrypt_hashPassword()',           delay: '2.1s', top: '18%', right: '5%'  },
  { type: 'FAIL', text: 'expiredToken_returns401()',       delay: '0.9s', top: '34%', right: '4%'  },
  { type: 'PASS', text: 'corsConfig_allowsFrontend()',     delay: '1.5s', top: '50%', right: '7%'  },
  { type: 'PASS', text: 'healthCheck_returnsUp()',         delay: '2.4s', top: '66%', right: '5%'  },
  { type: 'PASS', text: 'coverageScore_inValidRange()',    delay: '0.4s', top: '80%', right: '8%'  },
]
  ...
  useEffect(() => {
    function runAnimation() {
      ...
      TERMINAL_LINES.forEach((_, i) => {
        setTimeout(() => setVisible(prev => [...prev, i]), TERMINAL_LINES[i].delay)
      })
    }
...
export default function LoginPage() {
  ...
  function handleDemo() {
    login({ name: 'Demo User', email: 'demo@testgen.ai', token: 'demo-token', plan: 'free' })
    navigate('/home')
  }
      ...
      <div className={styles.left}>
        ...
        <div className={styles.leftInner}>
          ...
          <p className={styles.leftSub}>
            AI-powered test generation across 10 frameworks.
            Plain English in — production-ready test code out.
          </p>
