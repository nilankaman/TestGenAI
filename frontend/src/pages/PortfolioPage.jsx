...
const SKILLS = [
  ...
  {
    group: "Frameworks",
    items: ["Spring Boot", "React", "Node.js", "Maven", "Gradle"],
  },
  {
    group: "Languages",
  ...
  {
    group: "Tools & DevOps",
    items: ["JIRA", "Git", "GitHub Actions", "PostgreSQL", "Postman", "Docker"],
  },
];
        ...
        <div className={s.section}>
          <div className={s.aboutGrid}>
            <div className={s.aboutText}>
              ...
              <p className={s.bio}>
                QA Engineer and SDET with 4 years of professional experience
                (2019–2023) building automation frameworks from scratch. I've
                worked across web, mobile, and API testing using Selenium,
                Appium, and RestAssured, and I'm comfortable on the full stack —
                Spring Boot on the backend, React on the frontend.
              </p>
              <p className={s.bio}>
                Currently based in Tokyo and studying Japanese. Actively looking
                for QA/SDET or full-stack developer roles at companies working
                on interesting products. I built TestGen AI as a portfolio
                project to demonstrate what I can do end to end — from database
                schema and API design to React UI and CI/CD integration.
              </p>
                ...
                {[
                  {
                    icon: "🎓",
                    label: "Education",
                    value: "Bachelor's degree · Amity University",
                  },
                  {
                    icon: "🌍",
                    label: "Languages",
                    value: "English · Japanese (N4–N3) · Hindi",
                  },
                  {
                    icon: "📅",
                    label: "Experience",
                    value: "4 years professional + 3 years freelance",
                  },
                  {
                    icon: "🎯",
                    label: "Looking for",
                    value: "QA/SDET or Full-stack developer roles in Japan",
                  },
                ].map((f) => (
        ...
        <div className={s.section}>
          ...
          <div className={s.projectGrid}>
            {PROJECTS.map((p, i) => (
              <div
                key={i}
                className={`${s.projectCard} ${p.highlight ? s.projectHighlight : ""}`}
              >
                {p.highlight && (
                  <div className={s.projectFeatured}>Featured Project</div>
                )}
                <div className={s.projectHeader}>
                  <h3 className={s.projectName}>{p.name}</h3>
                  <span
                    className={`${s.projectStatus} ${p.status === "Live" ? s.statusLive : s.statusDone}`}
                  >
